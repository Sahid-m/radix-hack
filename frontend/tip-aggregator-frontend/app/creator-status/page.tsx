...
export default function CreatorStatusPage() {
  ...
  const handleClaimPayout = () => {
    ...
    toast({
      ...
      description: "All pending tips have been processed and sent to creators",
    })
  }

  // Get creator data
  const myPendingTips = isConnected
    ? contractState.pendingTips.filter((tip) => tip.creatorAddress === connectedAddress)
    : []

  const myHistory = isConnected ? contractState.tipHistory.filter((tip) => tip.creatorAddress === connectedAddress) : []
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white">Creator Status</h1>
          ...
          <Card className="bg-purple-800/50 border-purple-600 backdrop-blur-sm">
            <CardContent className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="text-purple-200">Connect your wallet to view your creator status and claim payouts</p>
              </div>
            </CardContent>
          </Card>
        ) : (
